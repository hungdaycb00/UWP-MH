#pragma checksum "C:\Users\Admin\source\repos\HK3\UWP-MH\MusicApp\MusicApp\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C3D857228D489412B6B59B9CAAF227DC"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MusicApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::MusicApp.Models.NewItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::MusicApp.Models.NewItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::MusicApp.Models.NewItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::MusicApp.Models.NewItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_category(global::MusicApp.Models.SoundCategory obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::MusicApp.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::MusicApp.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::MusicApp.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_newItems(obj.newItems, phase);
                        this.Update_sounds(obj.sounds, phase);
                    }
                }
            }
            private void Update_newItems(global::System.Collections.Generic.List<global::MusicApp.Models.NewItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_sounds(global::System.Collections.ObjectModel.ObservableCollection<global::MusicApp.Models.Sound> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 14: // MainPage.xaml line 40
                {
                    this.SearchSuggestion = (global::Windows.UI.Xaml.Controls.AutoSuggestBox)(target);
                }
                break;
            default:
                break;
