#pragma checksum "C:\Users\Admin\source\repos\HK3\UWP-MH\U44_FakeNews\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "5DF629D9E728EDB51B71EA2BB412C449"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace U44_FakeNews
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj8_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::U44_FakeNews.Model.NewItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::U44_FakeNews.Model.NewItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::U44_FakeNews.Model.NewItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::U44_FakeNews.Model.NewItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::U44_FakeNews.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::U44_FakeNews.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::U44_FakeNews.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_NewsItemGrid(obj.NewsItemGrid, phase);
                    }
                }
            }
            private void Update_NewsItemGrid(global::Windows.UI.Xaml.Controls.GridView obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
